  ...
  return (
    <footer style={{ background: 'var(--green)', color: 'rgba(255,255,255,0.8)', padding: '60px 5% 30px' }}>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 max-w-6xl mx-auto mb-12">
        ...
        <div>
          {/* Logo */}
          <Link to="/" className="no-underline flex items-center gap-3 mb-4">
            <img
              src={logoImg}
          ...
          <div className="flex gap-2 mt-5">
            {[
              { icon: 'fa-facebook-f', href: 'https://www.facebook.com/share/18soFmyKWQ/' },
              { icon: 'fa-instagram', href: 'https://www.instagram.com/vishnutravelindia' },
              { icon: 'fa-whatsapp', href: 'https://wa.me/918218034104' },
        ...
        <div>
          ...
          <ul className="list-none p-0 flex flex-col gap-3">
            {[
              { icon: 'fa-phone', href: 'tel:+918218034104', text: '+91 8218034104', fab: false },
              ...
              <li key={c.icon}>
                <a href={c.href}
                  ...
                  rel="noopener noreferrer"
                  className="no-underline text-sm flex items-center gap-2 transition-colors duration-200 hover:text-gold"
                  style={{ color: 'rgba(255,255,255,0.7)' }}>
      ...
      <div className="border-t max-w-6xl mx-auto pt-6 text-center text-xs opacity-60"
        ...
        © 2025 Vishnu Tour & Travel, Haridwar, Uttarakhand. All rights reserved. &nbsp;|&nbsp; Crafted with ♥ for the Land of Gods
      </div>
    </footer>
  )
}